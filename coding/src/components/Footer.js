...
const Footer = () => {
    return (
        ...
        // <span><i class="fa-brands fa-square-facebook text-white mr-2"></i></span><span><i class="fa-brands fa-linkedin  text-white"></i></span><span><i class="fa-brands fa-square-instagram  text-white"></i></span>
        //             <span><i class="fa-brands fa-square-facebook"></i></span><span><i class="fa-brands fa-linkedin"></i></span><span><i class="fa-brands fa-square-instagram"></i></span>
        //         </div>
